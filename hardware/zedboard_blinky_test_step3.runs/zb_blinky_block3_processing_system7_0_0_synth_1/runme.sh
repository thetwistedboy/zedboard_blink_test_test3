...
EAStep vivado -log zb_blinky_block3_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zb_blinky_block3_processing_system7_0_0.tcl
