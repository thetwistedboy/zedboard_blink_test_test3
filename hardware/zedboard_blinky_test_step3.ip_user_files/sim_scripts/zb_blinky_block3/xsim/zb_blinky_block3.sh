...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_22 -L processing_system7_vip_v1_0_24 -L axi_lite_ipif_v3_0_4 -L axi_uartlite_v2_0_39 -L interrupt_control_v3_1_5 -L axi_gpio_v2_0_37 -L proc_sys_reset_v5_0_17 -L smartconnect_v1_0 -L axi_register_slice_v2_1_36 -L axi_iic_v2_1_11 -L xlconstant_v1_1_10 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot zb_blinky_block3 xil_defaultlib.zb_blinky_block3 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim zb_blinky_block3 -key {Behavioral:sim_1:Functional:zb_blinky_block3} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_0970.protoinst" -protoinst "protoinst_files/zb_blinky_block3.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb zb_blinky_block3.wdb xsim.dir libdpi.so)
