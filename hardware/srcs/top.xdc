...
# JC Pmod - Bank 13
# ---------------------------------------------------------------------------- 
# Using this for ESP32 - PMOD0
#set_property PACKAGE_PIN AB6 [get_ports {Pmod_out_1_pin2_io}];  # "JC1_N"
#set_property PACKAGE_PIN AB7 [get_ports {Pmod_out_1_pin1_io}];  # "JC1_P"
#set_property PACKAGE_PIN AA4 [get_ports {Pmod_out_1_pin4_io}];  # "JC2_N"
#set_property PACKAGE_PIN Y4  [get_ports {Pmod_out_1_pin3_io}];  # "JC2_P"
#set_property PACKAGE_PIN T6  [get_ports {Pmod_out_1_pin8_io}];  # "JC3_N"
#set_property PACKAGE_PIN R6  [get_ports {Pmod_out_1_pin7_io}];  # "JC3_P"
#set_property PACKAGE_PIN U4  [get_ports {Pmod_out_1_pin10_io}];  # "JC4_N"
#set_property PACKAGE_PIN T4  [get_ports {Pmod_out_1_pin9_io}];  # "JC4_P"
...
## ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN F22 [get_ports {count_en}];  # "SW0"
